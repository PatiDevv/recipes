  ...
  return (
    <WrapSummary>
      ...
      <div>
        ...
        {isWeightHigherThanTargetWeight ? (
          <Summary definition="Deficyt kaloryczny:" value={quantityCalories + ' kcal'} />
        ) : (
          <Summary definition="Nadwyżka kaloryczna: " value={quantityCalories + ' kcal'} />
        )}
        <br />
